...
def build_options(dry_run, verbose, no_color, config_file):
...
def fake(dry_run, verbose, no_color, config_file, files_or_dirs, recursive):
    build_options(dry_run, verbose, no_color, config_file)
    c = config.DxoConfig(options)
